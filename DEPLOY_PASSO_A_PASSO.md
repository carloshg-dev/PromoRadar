# Deploy do PromoRadar — passo a passo
...
```powershell
cd C:\Users\CarlosAlineBianca\PromoRadar_COMPLETO
git init
git add .
git commit -m "PromoRadar - fundacao completa"
git branch -M main
git remote add origin https://github.com/paulohelon280/PromoRadar.git
...
**Confira:** abra `https://github.com/paulohelon280/PromoRadar` no navegador. Os arquivos devem aparecer lá — **menos** o `.env.local` (ele fica escondido de propósito, por segurança). Se você vir o `.env.local` na lista, PARE e me avise.
...
3. Na lista de repositórios, encontre **PromoRadar** e clique em **Import**.
...
5. Antes de clicar em Deploy, abra **Environment Variables** e adicione estas 4 (copie os nomes exatamente):
   ...
   | `CRON_SECRET` | *(invente uma senha qualquer, ex: `promoradar-2026-xyz`)* |

6. Clique em **Deploy** e aguarde uns 2 minutos.
7. No fim, a Vercel mostra o endereço do site (algo como `promoradar.vercel.app`). Abra para conferir.
