...
function FeatureItem({ icon: Icon, label }: { icon: LucideIcon; label: string }) {
  return (
    <div className="flex min-w-[132px] items-center gap-3 border-l border-white/10 pl-4 first:border-l-0 first:pl-0">
      <Icon className="h-7 w-7 shrink-0 text-[#00e46a] drop-shadow-[0_0_14px_rgba(34,224,107,.42)]" strokeWidth={1.7} />
      ...
      <div className="relative min-h-[940px] px-5 py-10 sm:min-h-[860px] sm:px-9 sm:py-12 lg:min-h-[760px] lg:px-12 lg:py-14 xl:min-h-[790px]">
        <div className="relative z-10 max-w-[620px]">
          ...
          <div className="mt-8 grid max-w-xl grid-cols-2 gap-4 sm:flex sm:flex-wrap sm:items-center sm:gap-0">
            <FeatureItem icon={ShieldCheck} label="Ofertas verificadas" />
            <FeatureItem icon={ChartNoAxesCombined} label="Histórico de preços" />
            <FeatureItem icon={BadgePercent} label="Cupons exclusivos" />
            <FeatureItem icon={BellRing} label="Alertas inteligentes" />
          </div>
        </div>
